...
const Sidebar = () => {
  return (
    <>
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 pt-16"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
          <a
            href="https://flowbite.com/"
            className="flex flex-col  items-center ps-2.5 mb-10"
          >
            ...
            <img
              ...
              className="h-16 me-3 sm:h-24  rounded-full"
              alt="Flowbite Logo"
            />

            <span className="text-gray-500">Pankaj Binwal</span>
            <span className="self-center mt-2 text-xl font-semibold whitespace-nowrap dark:text-white">
              Welcome to SCV
            </span>
          </a>
